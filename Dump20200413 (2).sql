...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$180000$egcq8DmIDYfY$DILwRzWq8WJH9iFA0wdgYGEoVcPrfbgc1q7y3bhw8X0=','2020-04-14 00:59:24.163582',1,'admin','','','admin@example.com',1,1,'2020-04-11 21:28:50.957488'),(2,'pbkdf2_sha256$180000$aTcHPlyT0fJF$5PrW9KPo0TDFuDHp/xNjNeeJtTYF5pZ5DEv/ZwDHe9M=','2020-04-14 02:26:47.245079',0,'bubble','Alice','Bubble','',0,1,'2020-04-13 02:55:16.000000');
...
INSERT INTO `django_session` VALUES ('yg5knusl36hl3qltfgj2wwc7gf7ygiho','MDc3MzliYTgyZjIyMGEwZGZlYjRmYTIzODZjZDY3ODI5MTcyYjZjYjp7Il9hdXRoX3VzZXJfaWQiOiIyIiwiX2F1dGhfdXNlcl9iYWNrZW5kIjoiZGphbmdvLmNvbnRyaWIuYXV0aC5iYWNrZW5kcy5Nb2RlbEJhY2tlbmQiLCJfYXV0aF91c2VyX2hhc2giOiI4NGRiN2EwYjVlMjc0Njg1OTY5ODUwZmI0ODMzYTlhMDM2NzAwODIyIn0=','2020-04-28 02:26:47.263327');
...
CREATE TABLE `msa_adoptedpet` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `pet_info_id_UNIQUE` (`pet_info_id`),
...
INSERT INTO `msa_adoptedpet` VALUES (1,'2020-04-12',1,1),(13,'2020-04-13',4,1),(33,'2020-04-13',3,2);
...
INSERT INTO `msa_petinfo` VALUES (1,'Mudkip',2,1,1,1,1),(2,'Turtwig',1,0,4,2,2),(3,'Torchic',1,1,6,3,3),(4,'Bulbasaur',2,1,NULL,1,5),(7,'Bonsly',1,0,NULL,2,5);
...
--
/*!50003 DROP PROCEDURE IF EXISTS `AdoptPet` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `AdoptPet`(IN petid INT, userid INT)
BEGIN
	INSERT INTO msa_adoptedpet (pet_info_id, user_id, date_adopted) VALUES (petid, userid,  CURDATE());
    UPDATE msa_petinfo SET adoption_status = 1 WHERE id = petid;
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetAllPetInfosFilterShelterOrSpecies` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetAllPetInfosFilterShelterOrSpecies`(IN species_id INT, IN shelter_id INT, IN city_id INT)
BEGIN
	SELECT msa_petinfo.id, msa_petinfo.name, msa_petinfo.age, msa_petinfo.adoption_status, msa_shelter.name AS shelter, msa_species.species_name, msa_breed.breed_name
		FROM msa_petinfo
			JOIN msa_shelter
				ON msa_petinfo.shelter_id = msa_shelter.id
			JOIN msa_city
				ON msa_shelter.city_id = msa_city.id 
			JOIN msa_species
				ON msa_petinfo.species_id = msa_species.id
			LEFT OUTER JOIN msa_breed
				ON msa_petinfo.breed_id = msa_breed.id
		WHERE
			IF ( ISNULL(species_id) = 1, TRUE, species_id = msa_petinfo.species_id )
					AND
			IF ( ISNULL(shelter_id) = 1, TRUE, shelter_id = msa_petinfo.shelter_id)
				AND
			IF ( ISNULL(city_id) = 1, TRUE, city_id = msa_city.id);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `RemoveAdoptPet` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `RemoveAdoptPet`(IN petid INT, userid INT)
BEGIN
	IF EXISTS (SELECT * FROM msa_adoptedpet WHERE msa_adoptedpet.pet_info_id = petid AND msa_adoptedpet.user_id = userid) THEN
    BEGIN
		DELETE FROM msa_adoptedpet WHERE msa_adoptedpet.pet_info_id = petid AND msa_adoptedpet.user_id = userid;
		UPDATE msa_petinfo SET adoption_status = 0 WHERE id = petid;
	END;
    END IF;
END ;;
DELIMITER ;
...
-- Dump completed on 2020-04-13 23:22:30
